...
if st.session_state.stage == "quatrième bloc":
    ...
    liste_reponse4["prenom"] = st.text_input("Prénom", key="prenom", autocomplete="off", max_chars=25)
    liste_reponse4["nom"] = st.text_input("Nom", key="nom", autocomplete="off", max_chars=25)
    liste_reponse4["adresse"] = st.text_input("Adresse", key="adresse", autocomplete="off", max_chars=150)
    liste_reponse4["mail"] = st.text_input("Mail", key="mail", autocomplete="off", max_chars=50)
    ...
    liste_reponse4["telephone"] = st.text_input("Téléphone", key="telephone", autocomplete="off", max_chars=15)
